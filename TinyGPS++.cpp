...
{
   updated = false;
   //long ret = rawLatData.deg + rawLatData.billionths;
   String ret = "";
   if(rawLatData.negative) {
     ret += "-";
   }
   ret += String(rawLatData.deg);
   ret += ".";
   ret +=String(rawLatData.billionths);
   return ret;
}
...
{
   updated = false;
   //double ret = rawLngData.deg + rawLngData.billionths;
   String ret = "";
   if(rawLngData.negative) {
     ret += "-";
   }
   ret += String(rawLngData.deg);
   ret += ".";
   ret +=String(rawLngData.billionths);
   return ret;
}
